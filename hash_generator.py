...
def gerar_hashs(string) -> list:
    ...
    hashs.append('Hash in sha1: ' + hash_obj_sha1 + '\n' + 'Size: ' + str(size))
    ...
    hashs.append('Hash in sha224: ' + hash_obj_sha224 + '\n' + 'Size: ' + str(size))
    ...
    hashs.append('Hash in sha256: ' + hash_obj_sha256 + '\n' + 'Size: ' + str(size))
    ...
    hashs.append('Hash in sha384: ' + hash_obj_sha384 + '\n' + 'Size: ' + str(size))
    ...
    hashs.append('Hash in sha512: ' + hash_obj_sha512 + '\n' + 'Size: ' + str(size))
